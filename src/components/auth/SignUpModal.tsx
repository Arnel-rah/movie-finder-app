...
const SignUpModal = ({
  ...
  const isFormValid =
    email && password && confirmPassword && username && isChecked;
      ...
      <div className="relative w-full max-w-md rounded-4xl border border-white/10 bg-[#0f0f0f] p-6 shadow-2xl font-sans">
        ...
        <form onSubmit={handleSignUp} className="space-y-3">
          ...
          <div className="flex items-center gap-3 pt-1">
            ...
            <label
              className="text-[11px] text-gray-400 select-none cursor-pointer"
              onClick={() => setIsChecked(!isChecked)}
            >
              I agree to our{" "}
              <span className="text-white font-bold">Privacy Policy</span> and{" "}
