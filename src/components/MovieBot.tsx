    ...
    try {
      ...
      const response = await puter.ai.chat([
        {
          role: "system",
          content:
            "You are the official SaintStream AI assistant. Use dark and sleek tone. Brand color is Green #00925d.",
        },
        {
          role: "user",
          content: userInput,
      ...
      setChatLog((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, I'm having trouble connecting to the stream. Please try again.",
        },
      ]);
    } finally {
      setIsLoading(false);
            ...
            {chatLog.length === 0 && (
              <div className="text-center mt-10">
                <p className="text-xs text-gray-500">
                  How can I help you find a movie today?
                </p>
              </div>
            )}
